package com.trabajosesion.proyectosesion.controller;
...
public class LoginController {
    ...
    public LoginController() {
        ...
        usuarios.put("Cocoproman", "ING2026S2");
        usuarios.put("Messinel", "ihatefrontend");
        usuarios.put("TombitaPasion", "doggod");
